...
class Meli(object):
    ...
    def post(self, path, body=None, params={}):
        ...
        response = requests.post(uri, data=body, params=urlencode(params),
                                 headers=headers)
        return response
    ...
    def put(self, path, body=None, params={}):
        ...
        response = requests.put(uri, data=body, params=urlencode(params),
                                headers=headers)
        return response
    ...
    def options(self, path, params={}):
        ...
        uri = self.make_path(path)
        response = requests.options(uri, params=urlencode(params),
                                    headers=headers)
        return response
